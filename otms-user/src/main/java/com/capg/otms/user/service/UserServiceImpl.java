...
public class UserServiceImpl implements IUserService {
	...
	@Override
	public Question updateQuestions(long testId, Question question) throws RestClientException, URISyntaxException {
		
		rt.put(new URI("http://localhost:8030/question/update"), question);
		rt.put(new URI("http://localhost:8020/test/assign/"+testId+"/question/"+question.getQuestionId()),null);
		return question;
	}
